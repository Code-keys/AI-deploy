...
bool Darknet::demo(){
    ...
    int input_image_size = 800;

    Darknet net("/home/nvidia/CX/VisDrone/yolov5sm.cfg", &device);
    ...
    net.load_weights("/home/nvidia/CX/VisDrone/yolov5sm.weights");
    ...
    cv::Mat origin_image = cv::imread("../139.jpg"); 
